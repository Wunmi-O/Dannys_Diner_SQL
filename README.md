...
Danny has provided me with a sample of his overall customer data due to privacy issues.
...
![](Danny_Diner_Entity_Relationship.png)
...
All datasets exist within the dannys_diner database schema. Find both schema and SQL scripts answering both questions **<ins>[here](Dannys_Store.sql)<ins>**
